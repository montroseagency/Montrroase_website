# Generated by Django 4.2.7 on 2025-11-06 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "admin_full_name",
                    models.CharField(
                        help_text="Full name for bank transfer", max_length=255
                    ),
                ),
                (
                    "iban",
                    models.CharField(
                        help_text="IBAN number for receiving payments", max_length=34
                    ),
                ),
                (
                    "bank_name",
                    models.CharField(
                        blank=True, help_text="Bank name (optional)", max_length=255
                    ),
                ),
                (
                    "swift_code",
                    models.CharField(
                        blank=True, help_text="SWIFT/BIC code (optional)", max_length=11
                    ),
                ),
                (
                    "additional_info",
                    models.TextField(
                        blank=True, help_text="Additional payment instructions"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "package",
                    models.CharField(default="No Plan Selected", max_length=255),
                ),
                (
                    "monthly_fee",
                ...
                ("account_manager", models.CharField(default="Admin", max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "client_full_name",
                    models.CharField(
                        help_text="Client's full name for verification", max_length=255
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "admin_message",
                    models.TextField(
                        blank=True, help_text="Message to admin from client"
                    ),
                ),
                (
                    "post_url",
                    models.URLField(
                        blank=True,
                        help_text="URL of posted content (set by admin)",
                        null=True,
                    ),
                ),
                (
